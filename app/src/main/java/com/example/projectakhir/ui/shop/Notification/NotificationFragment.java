...
public class NotificationFragment extends Fragment implements NotificationAdapter.OnNotificationClickListener {
    ...
    public void onGiveRatingClick(Notification notification) {
        // Implementasi aksi ketika tombol "Beri Penilaian" diklik
        Toast.makeText(getContext(), "Beri penilaian untuk: " + notification.getTitle(), Toast.LENGTH_SHORT).show();
        // Misal: Navigasi ke halaman penilaian, dsb.
    }
